cmd_src/test/net_udp_echo.o := clang -Wp,-MD,src/test/.net_udp_echo.o.d   -D__NAUTILUS__ -Iinclude  -include include/autoconf.h -D__NAUTILUS__ -fno-omit-frame-pointer -ffreestanding -fno-stack-protector -fno-strict-aliasing -fno-strict-overflow -mno-red-zone -mcmodel=large  -O2   -Wall -Wno-unused-function -Wno-unused-variable -fno-common -Wstrict-overflow=5  -fgnu89-inline -g -m64  -Wno-pointer-sign    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(net_udp_echo)"  -D"KBUILD_MODNAME=KBUILD_STR(net_udp_echo)" -c -o src/test/net_udp_echo.o src/test/net_udp_echo.c

deps_src/test/net_udp_echo.o := \
  src/test/net_udp_echo.c \
...
src/test/net_udp_echo.o: $(deps_src/test/net_udp_echo.o)
